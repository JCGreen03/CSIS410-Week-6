...
<body>
    ...
    if ($comments->num_rows > 0){
        while($row = $comments->fetch_assoc()) {
            ...
            <input type='text' id='title' size=30 name='title' value='" . $row['Title'] . "' required><br><br>
    
            <label for='comment'>Comment:</label><br>
            <textarea id='comment' name='comment' rows='4' cols='50' required>" . htmlspecialchars($row['Comments']) . "</textarea><br><br>
